...
## Que no se pierdan tus datos, usa localStorage 
...
## Que hay de nuevo?
1. Agregando valores al localStorage dentro de `main.js` usando `localStorage.setItem()`
2. Mostrando los valores guardados en el localStorage con `localStorage.getItem()`
