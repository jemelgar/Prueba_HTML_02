...
## Que hay de nuevo?
1. Nuevo modulo llamado `cookies.js` dentro de la carpeta /modules.
2. Agregar un evento al boton del modal para crear la cookie
3. Funcion para checar si la cookie esta creada.