...
## La web se actualiza, sessionStorage
...
## Que hay de nuevo?
1. Nuevas funciones dentro de `cookies.js` usando sessionStorage.
2. Se llama a las nuevas funciones para ver su comportamiento.
